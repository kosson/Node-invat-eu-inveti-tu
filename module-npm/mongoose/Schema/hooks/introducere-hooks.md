...
Mongoose respectă paradigma Node.js care este cea a gestionării de evenimente. Ceea ce ne este oferit cu aceste *hooks* (am putea traduce *cârlige*), este posibilitatea de a adăuga funcții (middleware), care să fie executate înainte sau după un event pe care *cârligul* îl ascultă, iar când evenimentul este declanșat, se execută callback-ul.

Când evenimentul este declanșat, funcțiile cu rol de callback preiau controlul în timpul execuției asincrone. Ceea ce trebuie înțeles din start este că numele evenimentelor sunt chiar numele metodelor aplicate pe model.
...
Mai jos avem exemplul unui scenariu în care executăm middleware atunci când ștergem ceva din baza da date.
